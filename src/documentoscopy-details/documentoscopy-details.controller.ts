// Arquivo: src/documentoscopy-details/documentoscopy-details.controller.ts
...
@Controller('documentoscopy-details')
@UseGuards(AuthGuard('jwt'), RolesGuard)
export class DocumentoscopyDetailsController {
  constructor(private readonly detailsService: DocumentoscopyDetailsService) {}

  @Post()
  @Roles(...ALLOWED_ROLES_TO_MANAGE)
  create(@Body() createDto: CreateDocumentoscopyDetailDto, @Req() req: any) {
  ...
  @Patch(':id')
  @Roles(...ALLOWED_ROLES_TO_MANAGE)
  update(@Param('id') id: string, @Body() updateDto: UpdateDocumentoscopyDetailDto, @Req() req: any) {
    const currentUser: User = req.user;
